	...
	(function (threejs) {
		class MeshBatcher extends THREE.Mesh {
			...
			constructor(maxVertices) {
				...
				this.geometry = geo;
				this.material = new threejs.SkeletonMeshMaterial();
			...
			batch(vertices, verticesLength, indices, indicesLength, z) {
				if (z === void 0) { z = 0; }
